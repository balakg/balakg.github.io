...
Compact neural representations of signals and images, spanning architecture design, multiscale modeling, and transferable priors.
...
Deep learning methods for clinical image analysis, including deformable registration, probabilistic segmentation, and sparse-view CT reconstruction.
...
Reconstructing and synthesizing 3D scenes and objects from images and video — buildings, face avatars, relightable objects, and crowd-free environments.
...
### <i class="fa-solid fa-satellite" style="color: #E8943A;"></i> Environmental Sensing and Geospatial AI

Machine learning for environmental monitoring — precipitation downscaling, land surface temperature, disaster damage assessment, and geospatial representation.

**Selected papers:** ISLAND ([Remote Sensing Applications 2024](https://github.com/way-yuhao/island)), Precipitation Downscaling ([TGRS 2025](https://doi.org/10.1109/TGRS.2025.3611872)), Debris Segmentation ([CAICE 2025](https://arxiv.org/abs/2504.12542)), GeoViSTA ([2026](https://arxiv.org/abs/2605.14406))
